...
class Tests {
    ...
    fun firstTestWithFile() {
        ...
        assertEquals("[someText 30.03.2022 20:17:26 613KB 111 rwx]", file.toString())
    }
    ...
    fun forthTestwithDir() {
        ...
        assertEquals("[anotherText2 30.03.2022 21:13:50 184KB 111 rwx, anotherText 30.03.2022 21:06:10 138KB 111 rwx]", dir.toString())
    }
}